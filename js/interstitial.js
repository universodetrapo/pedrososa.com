    ...
    PB = {
        ...
        addStyles: function () {
            ...
            var styles = [
                ...
                '#promoImage { height: auto; width: auto; max-width: 100%; max-height: 75%; box-sizing: border-box; display: block; border: 8px solid #000;background-color: #000; }',
                '#promoClose { position: absolute; top: 0; right: 0; display: block; line-height: 16px; text-align: right; padding: 24px 28px; color: #fff; z-index: 9992; font-family: sans-serif; font-size: 17px; opacity: 0.6; transition: 0.1s all; text-decoration: none; }',
        ...
        buildPromo: function () {
            ...
            this.promo = {
                ...
                image: PBlib.makeElement('div', {id: 'promoImage', src: o.imagePath}),
            ...
            document.getElementById('promoImage').innerHTML='<a href="http://vkm.is/dehidalgosycometas" target="blank"><img src="images/videoCabecera.png" style="border: 0" title="De Hidalgos y Cometas"/></a><iframe  width="100%" height="428" src="https://www.youtube.com/embed/Rj2P0iM7bvg?rel=0&autoplay=1&showinfo=0" frameborder="0" allowfullscreen></iframe><a href="http://vkm.is/dehidalgosycometas" target="blank"><img src="images/videoFaldon.png" style="border: 0" title="De Hidalgos y Cometas"/></a>';
        },
